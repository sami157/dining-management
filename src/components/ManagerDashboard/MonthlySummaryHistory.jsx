...
export const MonthlySummaryHistory = ({ totalExpenses, depositsData, finalizationData, finalizedByName, isLoading = false }) => {
    ...
    return (
        <section className="rounded-lg border border-base-300 px-4 py-3">
            ...
            <div className="divide-y divide-base-300">
                {isLoading ? (
                    Array.from({ length: 10 }).map((_, index) => <SummaryRowSkeleton key={index} />)
                ) : (
                    <>
