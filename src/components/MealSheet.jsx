                            ...
                            </thead>
                            {
                                ...
                                usersLoading ? (
                                    <tbody className='text-sm animate-pulse text-base-200/40'>
                                        <tr className='h-13 group'>
                                            <td colSpan={2}>
                                                <span className='h-10 w-60 bg-base-200/40 rounded-lg p-2 animate-pulse'>..........................................................</span>
                                            </td>
                                            <td className='text-center w-full rounded-lg flex items-center justify-center gap-4'>
                                                <MealBox />
                                                <MealBox />
                                                <MealBox />
                                            </td>
