        ...
        <div className='flex flex-col h-full m-2 rounded-lg overflow-hidden p-2 sm:p-4 transition-all duration-300 border border-base-300'>
            {
                (usersLoading || registrationsLoading) ? (
                    // Loading Skeleton
                    <div className="skeleton space-y-4 p-4 bg-base-200/40 w-95">
                                        ...
                                        <th className='text-center py-4'>
                                            <div className='flex  gap-6 justify-center items-center'>
                                                ...
                                                <div className="flex flex-col justify-center items-center">
                                                    <span>M</span>
                                                    <span className=" font-bold rounded-md">({mealTotals.morning})</span>
                                                </div>
                                                {/* E Column Header */}
                                                <div className="flex flex-col justify-center items-center">
                                                    <span>E</span>
                                                    <span className=" font-bold">({mealTotals.evening})</span>
                                                </div>
                                                {/* N Column Header */}
                                                <div className="flex flex-col justify-center items-center">
                                                    <span>N</span>
                                                    <span className=" font-bold">({mealTotals.night})</span>
                                                </div>
                                            </div>
                                        </th>
                                    </tr>
