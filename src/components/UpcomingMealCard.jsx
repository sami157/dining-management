...
const UpcomingMealCard = ({ date, schedule = {}, refetch }) => {
                    ...
                    {meals.length > 0 ? (
                        meals.map((meal) => {
                            ...
                            return (
                                <div
                                    key={meal.mealType}
                                    className={`relative group rounded-xl border transition-all duration-300 overflow-hidden ${isReg ? 'bg-primary/5 border-primary/30' : 'bg-base-200/50 border-base-300'
                                        }`}
                                >
                                    <div className="p-4">
                                            ...
                                            <div className="flex items-center gap-3">
                                                {isReg && (
                                                    <div className="flex items-center gap-1 bg-base-100 p-1 rounded-lg border border-base-300 shadow-sm">
                                                        ...
                                                        <span className="text-[10px] font-black min-w-[12px] text-center text-primary">
